...
myJavanTech.controller('fgdController', ['$scope', '$http', '$log', 'ngDialog', '$location', '$window', function ($scope, $http, $log, ngDialog, $location, $window, $route, $routeParams, $timeout) {
    ...
    $scope.delete = function (ID, title) {
        ...
        if (conf) {
            ...
            console.log(data);
            $http.post(base_url + "fgd/delete", data).success(function (r) {
                console.log(r);
                data = {
                    search: $scope.txtSearch || "",
                    writer: "",
