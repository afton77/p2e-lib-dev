...
class Laporanpenelitian extends CI_Controller {
  ...
  function __construct() {
    ...
    $this->load->model('laporanpenelitian_model', 'lp_model', TRUE);
...
//      $this->data['totalrow'] = $this->lp_model->getRow($filter, $writer);
    $this->data['json'] = $this->lp_model->getDatas($itemPerPage, $currentPage, $filter, $writer, $year);
    $this->data['totalrow'] = $this->lp_model->getRow($filter, $writer);
  ...
  function getData($id = null) {
    $data = "";
    $this->data['json'] = $this->lp_model->getData($id);
    $this->data['id'] = $id;
    echo json_encode($this->data);
  }
