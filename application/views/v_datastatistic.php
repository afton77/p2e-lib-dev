...
<div class="container">
  <div ng-controller="dataStatisticController">
    <div class="row">
      ...
      <table class="table table-striped">
        <tbody>
          <tr ng-repeat="r in names">
            <td>
              <h3>{{r.title}}</h3>
              <p><span class="label label-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Sumber</span> 
                <button type="button" ng-click="selectWriter(r.source)" class="btn btn-link">{{r.source}}</button>
...
<script src="<?php echo base_url(); ?>assets/angular-javantech/datastatistic.js" type="text/javascript"></script>
