        ...
        <div class="panel-body">
          <form enctype="multipart/form-data" name="myForm">
            ...
            <div class="form-group">
              ...
              <span style="color:red" ng-show="myForm.txtSource.$dirty && myForm.txtSource.$invalid">
                <span ng-show="myForm.txtSource.$error.required">Penulis harus diisi</span>
              </span>
              <input type="text" class="form-control" id="Penulis" name="txtSource" ng-model="txtSource" placeholder="Penulis" required>
            </div>
            <div class="form-group">
...
<script src="<?php echo base_url(); ?>assets/angular-javantech/datastatisticPost.js" type="text/javascript"></script>
