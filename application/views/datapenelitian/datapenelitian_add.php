...
<?php echo form_open_multipart(base_url() . '/datapenelitian/', array('id' => 'addForm', 'name' => 'addForm')); ?>
<?php echo $custom_error; ?>
<div class="row">
    <div class="three column">
        <h3>Data Penelitian (Penambahan)</h3>
    </div>
    <div class="three column">
        <?php
        echo anchor(base_url() . 'datapenelitian/datapenelitian/', 'Summary', array('class' => 'small button'));
        ?>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#addForm').ajaxForm({
            url: '<?php echo base_url() ?>/datapenelitian/datapenelitian/insert',
            type: 'post',
