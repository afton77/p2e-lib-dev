          ...
          <form enctype="multipart/form-data" name="myForm">
            ...
            <div class="form-group">
              ...
              <span style="color:red" ng-show="myForm.txtEmail.$dirty && myForm.txtEmail.$invalid">
                ...
                <span class="error" ng-show="myForm.txtEmail.$error.email"> Format surel Anda tidak benar!</span>
              </span>
              <input type="email" class="form-control" id="Penulis" name="txtEmail" ng-model="txtEmail" placeholder="Email" required>
            </div>
            <div class="form-group">
...
<script src="<?php echo base_url(); ?>assets/angular-javantech/strategicstudiesPost.js" type="text/javascript"></script>
